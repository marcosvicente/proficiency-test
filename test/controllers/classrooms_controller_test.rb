...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { curso_id: @classroom.curso_id, entry: @classroom.entry, student_id: @classroom.student_id }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { curso_id: @classroom.curso_id, entry: @classroom.entry, student_id: @classroom.student_id }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
